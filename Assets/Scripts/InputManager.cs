...
public class InputManager : MonoBehaviour
{
   ...
   public MoveInputEvent moveInputEvent;
    ...
    public PlaceInputEvent placeInputEvent;
    ...
    private void OnEnable()
    {
        ...
        pC.Gameplay.PlaceMarker.performed += OnPlaceMarkerPerformed;
    }
    ...
    private void OnPlaceMarkerPerformed(InputAction.CallbackContext ctx)
    {
        //placeInputEvent.Invoke();
    }
}
